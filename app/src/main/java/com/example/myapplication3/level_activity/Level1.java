...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IMG_LEFT.setImageResource(array.architecturalHeritages[numLeft].getImage());
        TEXT_LEFT.setText(array.architecturalHeritages[numLeft].getName());
        ...
        IMG_RIGHT.setImageResource(array.architecturalHeritages[numRight].getImage());
        TEXT_RIGHT.setText(array.architecturalHeritages[numRight].getName());
        ...
        IMG_LEFT.setOnTouchListener((v, event) -> {
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                if (array.architecturalHeritages[numLeft].getYer() > array.architecturalHeritages[numRight].getYer()) {
